...
internal class FilterBreedsUseCaseTest {
    ...
    fun `When filtering by quantity, it must return from highest to lowest`(){
        val listDisorder = listOf(
            BreedModel(0, breedName = "", amount = 23, image = "", idCategory = 0),
            BreedModel(0, breedName = "", amount = 13, image = "", idCategory = 0),
            BreedModel(0, breedName = "", amount = 32, image = "", idCategory = 0),
            BreedModel(0, breedName = "", amount = 12, image = "", idCategory = 0),
            BreedModel(0, breedName = "", amount = 25, image = "", idCategory = 0),
        )
    ...
    fun `When filtering by name, it must return in alphabetical order`(){
        val listDisorder = listOf(
            BreedModel(0, breedName = "a", amount = 23, image = "", idCategory = 0),
            BreedModel(0, breedName = "s", amount = 13, image = "", idCategory = 0),
            BreedModel(0, breedName = "v", amount = 32, image = "", idCategory = 0),
            BreedModel(0, breedName = "e", amount = 12, image = "", idCategory = 0),
            BreedModel(0, breedName = "r", amount = 25, image = "", idCategory = 0),
        )
    ...
    fun `When filtering by name and id category, it must return in alphabetical order`(){
        val listDisorder = listOf(
            BreedModel(0, breedName = "a", amount = 23, image = "", idCategory = 0),
            BreedModel(0, breedName = "s", amount = 13, image = "", idCategory = 1),
            BreedModel(0, breedName = "v", amount = 32, image = "", idCategory = 2),
            BreedModel(0, breedName = "e", amount = 12, image = "", idCategory = 1),
            BreedModel(0, breedName = "r", amount = 25, image = "", idCategory = 0),
        )
